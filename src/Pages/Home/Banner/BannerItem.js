    ...
    return (
        <div id={`slide${id}`} className="carousel-item relative w-full">
            ...
            <div className="absolute flex justify-end transform -translate-y-1/2 left-24  top-1/2">
                <p className='text-white'>There are many variations of passages of  available, <br /> but the majority have suffered alteration in some form</p>
            </div>
            <div className="absolute flex justify-start transform -translate-y-1/2 left-24  top-3/4">
                ...
                <button className="btn btn-outline btn-warning">Latest Poject</button>
            </div>
